...
void ntt_4core_new(UDTYPE operand[bramnum][bramsize],
                   ...
                   UDTYPE srp[RPBRAMNUM][RPBRAMSIZE], UDTYPE modulus) {
...
#pragma HLS UNROLL
      ...
      operanda_[0] =
          static_cast<UDTYPE>(operanda_[0]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operanda_[0] >= two_times_modulus)));
      operand[0][MEa] =
          static_cast<UDTYPE>(operanda_[0]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operanda_[0] >= modulus)));

      operandb_[0] =
          static_cast<UDTYPE>(operandb_[0]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operandb_[0] >= two_times_modulus)));
      operand[1][MEb] =
          static_cast<UDTYPE>(operandb_[0]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operandb_[0] >= modulus)));

      operanda_[1] =
          static_cast<UDTYPE>(operanda_[1]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operanda_[1] >= two_times_modulus)));
      operand[2][MEa] =
          static_cast<UDTYPE>(operanda_[1]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operanda_[1] >= modulus)));

      operandb_[1] =
          static_cast<UDTYPE>(operandb_[1]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operandb_[1] >= two_times_modulus)));
      operand[3][MEb] =
          static_cast<UDTYPE>(operandb_[1]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operandb_[1] >= modulus)));

      operanda_[2] =
          static_cast<UDTYPE>(operanda_[2]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operanda_[2] >= two_times_modulus)));
      operand[4][MEa] =
          static_cast<UDTYPE>(operanda_[2]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operanda_[2] >= modulus)));

      operandb_[2] =
          static_cast<UDTYPE>(operandb_[2]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operandb_[2] >= two_times_modulus)));
      operand[5][MEb] =
          static_cast<UDTYPE>(operandb_[2]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operandb_[2] >= modulus)));

      operanda_[3] =
          static_cast<UDTYPE>(operanda_[3]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operanda_[3] >= two_times_modulus)));
      operand[6][MEa] =
          static_cast<UDTYPE>(operanda_[3]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operanda_[3] >= modulus)));

      operandb_[3] =
          static_cast<UDTYPE>(operandb_[3]) -
          (two_times_modulus & static_cast<UDTYPE>(-static_cast<DTYPE>(
                                   operandb_[3] >= two_times_modulus)));
      operand[7][MEb] =
          static_cast<UDTYPE>(operandb_[3]) -
          (modulus &
           static_cast<UDTYPE>(-static_cast<DTYPE>(operandb_[3] >= modulus)));
